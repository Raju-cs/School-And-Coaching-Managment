var Controller = new function () {
    ...
    const studentDateFilter = { "field": "Name", "value": '', Operation: 0 }, ModuleList = {}, Page = { 'Id': '', 'PageNumber': 1, 'PageSize': 20, filter: [periodFilter] };
    ...
    //            Type: 'AutoComplete',
    //            // page: { Id: page.StudentId, 'PageNumber': 1, 'PageSize': 20, filter: [{ "field": "smIsDeleted", "value": 0, Operation: 0 }, periodFilter] }
    //            page: Page
    ...
    //            formModel.StudentId = page.StudentId;
    //            formModel.PeriodId = _options.PeriodId;
    //            formModel.ModuleId = formModel.ModuleId;
    //            formModel.SubjectId = page.SubjectId;
    //            formModel.IsActive = true;
    //            formModel.ModuleFee = page.Charge;
    //            formModel.TotalFee = model.ModuleFee;
    ...
    (function () {
        ...
        function getDaily(id, name, container, filter) {
            return {
                ...
                columns: [
                    { field: 'DreamersId', title: 'DreamersId', filter: true, position: 1, width: 108 },
                    { field: 'StudentName', title: 'Student Name', filter: true, position: 2, Click: studentInfo, width: 150  },
                    { field: 'Class', title: 'Class', filter: true, position: 3, width: 82  },
                    { field: 'PhoneNumber', title: 'PhoneNumber', filter: true, position: 4, width: 126  },
                    { field: 'Charge', title: 'Fees', filter: true, position: 5, width: 76  },
                    { field: 'Paid', title: 'Paid', filter: true, position: 6, width: 75  },
                    { field: 'Due', title: 'Due', filter: true, position: 7, width: 131 },
