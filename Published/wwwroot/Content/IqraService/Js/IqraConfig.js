var IqraConfig = {
    Text: {
        Branch:'Uttara',
        Title: 'Dreamer`s.',
        Address: 'House-25, Ishakha Avenue, Sector-06,Uttara, Dhaka-1230.',
        Phone: 'Phone : 01401-430059'
    }
};
    ...
    Grid: {
        ...
        Printable: {
            ...
            header: `<div style="text-align:center; margin-bottom:20px;">
                        ...
                        <div class="report_title" style="font-size:1em; margin-top:10px;"></div>
                    </div>`,
            reportTitle: function (model) {
                console.log("model=>", model.ModuleName);
                var text = '';
                return (model.title || model.name || model.ModuleName ) +' Report';
            },
            summaryTitle: () => '',
            summaryFooter: () => '',
            gridTitle: () => '',
