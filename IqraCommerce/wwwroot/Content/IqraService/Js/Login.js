var LogIn = new function () {
    ...
    function submit() {
        if (bindingModel.IsValid) {
            ...
            Global.Busy();
            Global.CallServer('/ManagedArea/Account/LogIn/', function (response) {
                Global.Free();
                if (!response.IsError) {
                    location.href = "/";
                } else {
    ...
    this.ForgetPassword = new function () {
        ...
        this.Show = function () {
            ...
            if (windowModel) {
                ...
                Global.Wait();
                Global.LoadTemplate('/Areas/ManagedArea/Account/Templates/ForgetPassword.html', function (response) {
                    Global.Free();
