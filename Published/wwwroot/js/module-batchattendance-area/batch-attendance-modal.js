var Controller = new function () {
    ...
    this.Show = function (options) {
        ...
        const attenDanceHistory = (row, model) => {
            console.log("row=>", row);
            Global.Add({
                name: 'Attendance History' + row.Id,
                url: '/js/module-batchattendance-area/attendanceHistory.js',
                updatePayment: model.Reload,
                Id: row.Id,
                BatchId: row.BatchId,
                BatchId: _options.BatchId,
                        ...
                        actions: [
                            {
                                ...
                                html: `<a class="action-button info t-white"><i class="glyphicon glyphicon-list-alt" title="Make Student Attendance"></i></a>`
                            }, {
                                click: attenDanceHistory,
                                html: `<a class="action-button info t-white"><i class="glyphicon glyphicon-info-sign" title="Batch Student Attendance History"></i></a>`
                            }
                        ],
                        buttons: [
                            {
