var Controller = new function () {
    ...
    var _options;
        ...
        this.Show = function (options) {
            ...
            function courseExamination(page) {
                ...
                Global.Add({
                    ...
                    onSubmit: function (formModel, data, model) {
                        ...
                        formModel.ExamBandMark = model.ExamBandMark;
            ...
            function editCourseExamination(model, grid) {
                Global.Add({
                ...
                Tabs: [
                    {
                        ...
                        Grid: [{
                            ...
                            Url: '/Routine/Get/',
                            filter: [courseFilter, batchFilter],
                        ...
                        Grid: [{
                            ...
                            columns: [
                                ...
                                { field: 'ExamBandMark', title: 'ExamBandMark', filter: true, position: 3, add: false },
                                { field: 'Remarks', title: 'Remarks', filter: true, add: { sibling: 2, }, required: false, position: 6, },
                            ],
