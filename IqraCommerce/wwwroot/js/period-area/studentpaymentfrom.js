...
const renderHTML = (windowToPrint, report) => {
    ...
    renderPersonalInfo(windowToPrint, report, outputText);
    ...
    <header class="header-area">
                ...
                <div class="header-right">
                    <div class="inner-right">
                       <p>House-25, Ishakha Avenue, Sector-06</p>
...
const renderPersonalInfo = (windowToPrint, report, outputText) => {
  ...
  <div class="personal-information-main">
                <div class="personal-info-inner">
                    ...
                    <div class="inner-repeat-item">
                        ...
                        <div class="repeat-item">
                            <h4 class="cmn-text"><b>Batch</b> : <span>${report.BatchName}</span></h4>
                        </div>
                    </div>

                     <div class="inner-repeat-item">
                        <div class="repeat-item">
                            <h4 class="cmn-text"><b>Module</b> : <span>${report.ModuleName}</span></h4>
                        </div>
                        <div class="repeat-item">
                            <h4 class="cmn-text"><b>Month</b> : <span>${report.Name}</span></h4>
                        </div>
                    </div>

                     <div class="repeat-item">
                        <h4 class="cmn-text">Subject Name: <span>${report.SubjectName}</span></h4>
                    </div>
